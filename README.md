...
The older column stack it replaced has been deleted from the tree.
...
The column-based predecessor was deleted once the voxel stack took
over. `docs/VOXEL_MIGRATION.md` records what it modelled and why the
sim moved to cells.
