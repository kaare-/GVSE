...
const WATER: &[(&str, LineKind)] = &[
    ...
    ("Dry porous faces soak at the material permeability rate each tick,", LineKind::Body),
    ("slowing as pores fill so recharge is gradual — not a sponge pour.", LineKind::Body),
