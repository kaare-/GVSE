...
const WATER: &[(&str, LineKind)] = &[
    ...
    ("Thin films crawl. A hilltop dump keeps a fat leading edge and", LineKind::Body),
    ("climbs or skips a dry column — it does not fill the column first.", LineKind::Body),
