...
const KEYS: &[(&str, LineKind)] = &[
    ...
    ("N        leftover parcel animation (off — the field is the cloud)", LineKind::Body),
    ("H        humidity vapour field + wind streaks (default on)", LineKind::Body),
...
const WATER: &[(&str, LineKind)] = &[
    ...
    ("C already pays from humidity. Leftover N parcels do not hold water.", LineKind::Body),
