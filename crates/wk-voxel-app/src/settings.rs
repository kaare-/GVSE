...
use wk_voxel::{
    ...
    MAX_ROOT_MODULES, MAX_STEM_MODULES, PRESET_DIR,
};
        ...
        widgets::Window::new(hash!(), vec2(12.0, 12.0), vec2(win_w, win_h))
            ...
            .ui(&mut *root_ui(), |ui| {
                ...
                ui.tree_node(hash!(), "Wind + humidity", |ui| {
                    ...
                    ui.label(
                        None,
                        "Local field (V overlay): terrain / thermal / swirl reshape the climate mean. Canopy dampen uses tall stems when present.",
                    );
                    labeled_slider(
                        ui,
                        hash!(),
                ...
                ui.tree_node(hash!(), "Clouds (N visual echo)", |ui| {
                    ...
                    labeled_slider(ui, hash!(), "Cloud-base scale above sea", 8.0..160.0, &mut cloud_alt);
