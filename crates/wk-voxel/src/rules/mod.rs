...
pub use grain::{
    ...
    wake_grains_for_settle, wake_grains_for_settle_coords, wake_unsupported_grains,
    wake_unstable_slopes, GrainConfig, GRAIN_REPOSE_HAZE_MAX, GRAIN_REPOSE_LAKE_MIN,
    GRAIN_SETTLE_PASSES, GRAIN_SETTLE_PASSES_SHALLOW, MYCELIUM_EROSION_BIND,
