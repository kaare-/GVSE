...
pub use fungi::{
    ...
    seed_mycelium_near, sip_mycelium_energy_near, soft_litter_at, stamp_mycelium_lineage,
    step_mycelium_field, step_mycelium_field_cfg, swap_cells_preserving_mycelium,
    swap_mycelium_meta, FungiConfig, MyceliumLineage, MyceliumLineageMap,
    FUNGUS_STALK_SPORE_MAX_DIST, FUNGUS_STALK_SPORE_MIN_DIST, MYCELIUM_ENERGY_CAP,
};
pub use geotech_map::{
