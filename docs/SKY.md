...
| Humidity tiles | Diagnostic haze overlay (`H`) — 4×4 seats; skip the 1-wide drop; refill an emptied seat from a wrapped neighbour; bilinear may soften a wet seat |
