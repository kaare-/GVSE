...
| **S2** | Joints + scripted muscle + hydro push + muscle feedback | ✅ True pivot rotation; serial hinge chains; free (unfixtured) assemblies fall + wobble; skin/nerve/muscle ride host bones; `tests/hinge_*.rs`, `tests/tissue_follows.rs` |
