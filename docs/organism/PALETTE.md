...
| `0x16` | Symbiont | `#3DBE9A` | Opt-in plant↔fungus partnership organ. Genome `(sym_water, sym_energy)` is the mutable agreed deal; both partners need the module. Assortative match; lopsided same vector = parasitism. |
...
| `0x14` | Muscle | `#C33C3C` | Placeholder for animal motility engine. |
| `0x15` | Bone | `#EFE7DA` | Placeholder for animal skeletal element. |
