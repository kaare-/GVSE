...
| Soft-lid burst | Only when the soft column opens to **free atmosphere**. Buried grain lenses under competent rock do **not** burst into Air pipes. Ejecta relocates above / outside the chamber (or fluidizes to suspended) — never dumps into the pressure void. Assault / escape widen competent rock as **high-aperture conduits** (`mint_void = false`); they do not mint cheap Air columns through rock. |
